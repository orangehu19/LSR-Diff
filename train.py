...
def parse_args_and_config():
    ...
    parser.add_argument("--image_folder", default='./output/train/results/', type=str,
    ...
    parser.add_argument('--output_dir', type=str, default='./output/train', help='Output directory for results')
